...
public record RunRequest(String requirement,Workflow workflow,String workspaceId,String repositoryKey,String ref,String title,String caseId){
 public RunRequest validate(GitWorkspace git){
  if(title!=null&&title.length()>160)throw new ApiFailure(422,"TITLE_TOO_LONG");
